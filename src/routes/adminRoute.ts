...
router.post("/specialization",authMiddleware(['admin']),adminController.addspecialization.bind(adminController))
...
router.put("/specialization/:id",authMiddleware(['admin']),adminController.updatespecialisation.bind(adminController))
